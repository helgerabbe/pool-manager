...
import { getMappingsByAufgabe, createMapping, deleteMapping, getBasisMappingsByAufgabe, createBasisMapping, deleteBasisMapping, filterMappingsFuerSchritt } from '@/services/AllgemeineAufgabeService';
