 ...
 * Setzt content_status auf 'approved' / zurück auf 'draft'.
 * Zeigt Sicherheitsabfrage wenn Pflichtfelder fehlen.
 */
export default function PublishProjektaufgabeButton({ aufgabe, kannBearbeiten = false, userRole }) {
  ...
  const approveMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast.success('✅ Projektaufgabe freigegeben – jetzt im Export-Cockpit sichtbar');
      ...
      <div className="flex flex-col gap-1.5">
        ...
        {isPendingExport && (
          <p className="text-[11px] text-orange-700 leading-snug max-w-xs">
            Die Freigabe kann gerade nicht zurückgenommen werden, weil sich die Aufgabe im Export befindet.
            Sobald der Export abgeschlossen ist, kann hier wieder gearbeitet werden.
          </p>
        )}
      </div>
    );
