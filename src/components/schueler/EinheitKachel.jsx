...
export default function EinheitKachel({ einheit, fachFarbe, fortschritt, nummer, zeitLogs = [], notizen = [], userEmail }) {
  ...
  return (
    <div
      className={cn(
        'group flex flex-col rounded-2xl border bg-card p-5 shadow-sm hover:shadow-md transition-all',
        abgeschlossen ? 'border-emerald-300 bg-emerald-50/40' : 'border-border hover:border-primary/40'
      )}
    >
