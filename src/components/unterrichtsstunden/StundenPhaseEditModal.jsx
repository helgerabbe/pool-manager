/**
 * Bearbeitung einer einzelnen Phase des Stunden-Regieblatts (MUG Paket 3):
...
export default function StundenPhaseEditModal({ phase, stundeId, open, onClose }) {
        ...
        <div className="space-y-4">
          <div className="grid gap-3 sm:grid-cols-3">
            <div className="sm:col-span-2 space-y-2">
              ...
              <Input value={form.phasenname} onChange={(e) => set('phasenname', e.target.value)} />
            </div>
          ...
          <div className="space-y-2">
            ...
            <Textarea rows={3} value={form.lehrer_hinweis} onChange={(e) => set('lehrer_hinweis', e.target.value)} />
          </div>
          ...
          <div className="grid gap-3 sm:grid-cols-3">
            <div className="space-y-2">
              ...
              <Textarea rows={2} value={form.differenzierung.standard || ''} onChange={(e) => setDiff('standard', e.target.value)} />
            </div>
            <div className="space-y-2">
              <Label>★★ Leistungsstark</Label>
              <Textarea rows={2} value={form.differenzierung.stark || ''} onChange={(e) => setDiff('stark', e.target.value)} />
            </div>
            <div className="space-y-2">
              <Label>Förderung</Label>
              <Textarea rows={2} value={form.differenzierung.foerderung || ''} onChange={(e) => setDiff('foerderung', e.target.value)} />
            </div>
          </div>
