...
export default function WizardStep5Phasen({ einheitId, onDone, onSkipAll }) {
  const queryClient = useQueryClient();
  const [generating, setGenerating] = useState(false);
  const [done, setDone] = useState(false);
  const [phasenConfig, setPhasenConfig] = useState({});
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-lg font-semibold">Schritt 5: Lernphasen konfigurieren</h2>
