    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-2xl max-h-[85vh] overflow-y-auto">
        ...
        <div className="space-y-5 py-4">
          {/* Aufgabenstellung – nur wenn die Aufgabenart kein eigenes
              Aufgabentext-Feld mitbringt (sonst doppelte Aufgabenstellung). */}
          {!formSchema.some(f => f.field_name === 'aufgabentext') && (
            ...
            formSchema.map(field => {
              ...
              return (
                <div key={field.field_name} className="space-y-2">
                  {/* 'aufgabentext' bringt seine eigene Beschriftung mit. */}
