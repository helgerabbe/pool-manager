...
import KICheckPreviewModal from '@/components/workspace/preview/KICheckPreviewModal';
...
export default function ActivityMasterPanel({
  ...
  // Lehrwerk / Quelle: Schüler-Vorschau.
  const [lehrwerkPreviewOpen, setLehrwerkPreviewOpen] = useState(false);
  ...
  // KI-Check: Schüler-Vorschau (Wechsel zu Brian).
  const [kiCheckPreviewOpen, setKiCheckPreviewOpen] = useState(false);
  // Slideshow: Schüler-Vorschau (Folien durchblättern).
        ...
        return (
          <>
            ...
            {kannBearbeiten && (
              ...
              />
              <KICheckPreviewModal
                open={kiCheckPreviewOpen}
                onOpenChange={setKiCheckPreviewOpen}
                fieldValues={fieldValues}
                catalogName={catalogEntry?.name}
                phase={activityRecord?.phase}
              />
              <SlideshowPreviewModal
                open={slideshowPreviewOpen}
                onOpenChange={setSlideshowPreviewOpen}
                fieldValues={fieldValues}
                catalogName={catalogEntry?.name}
                phase={activityRecord?.phase}
              />
            ...
            ) : catalogEntry?.name?.toLowerCase().includes('slideshow') ? (
              <SlideshowReadOnly fieldValues={fieldValues} />
