/**
 * ImageLabelingModalDetail.jsx
 *
 * Modal für die Bearbeitung von "Bildbeschriftung" Aktivitäten.
...
export default function ImageLabelingModalDetail({
  open,
  onOpenChange,
  initialData = {},
  onSave,
      ...
      <DialogContent className="max-w-2xl max-h-[90dvh] flex flex-col p-0 gap-0">
        ...
        <DialogHeader className="px-6 py-4 border-b border-border shrink-0">
          ...
          <p className="text-xs text-muted-foreground mt-0.5">
            Definiere das Hintergrundbild und die Zielbegriffe für diese Aufgabe.
          </p>
        </DialogHeader>
