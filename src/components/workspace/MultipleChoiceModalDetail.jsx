/**
 * MultipleChoiceModalDetail.jsx
 *
 * Modal für die Bearbeitung von "Multiple Choice" Aktivitäten.
...
export default function MultipleChoiceModalDetail({
  open,
  onOpenChange,
  initialData = {},
  onSave,
      ...
      <DialogContent className="max-w-2xl max-h-[90dvh] flex flex-col p-0 gap-0">
        ...
        <DialogHeader className="px-6 py-4 border-b border-border shrink-0">
          ...
          <p className="text-xs text-muted-foreground mt-0.5">
            Erstelle Multiple-Choice-Fragen mit korrekten Antworten für diese Aufgabe.
          </p>
        </DialogHeader>
