...
const getVisibleTabs = (rolle) => {
  ...
  },
  {
    ...
    help: {
      ...
      description: 'In diesem Tab erstellst du als Fachlehrkraft die allgemeinen Transfer-Aufgaben deiner Einheit (Ebene 2). Das sind die größeren, offenen Aufgaben, bei denen Schüler:innen das in den Lernpaketen Gelernte auf eine neue Situation anwenden müssen – z. B. eine Quelle analysieren, ein Diagramm auswerten oder eine kurze Erörterung schreiben. Begleitet werden sie dabei vom KI-Tutor Brian.study, den du in diesem Tab gleich mit konfigurierst. Beim Anlegen einer neuen Aufgabe wählst du zuerst in einem Dialog die Art der Mission (z. B. Problem, Entdeckung, Recherche, Anwendung, Transfer, Kreativität) – sie bestimmt die didaktische Stoßrichtung der Aufgabe.',
      features: [
        'Du legst eine neue Aufgabe über den Dialog an und wählst dort die Art der Mission (Problem · Entdeckung · Recherche · Anwendung · Transfer · Kreativität)',
        'Du beschreibst Aufgaben mit Text, Bild, PDF oder Materialien aus dem Lehrwerk und setzt einen Schwierigkeitsgrad (1–3 Sterne)',
        'Du holst dir aus der KI-Ideenbox passende Aufgaben-Vorschläge für die Einheit, wenn dir der zündende Einfall fehlt',
      ...
      faqs: [
        { question: 'Was ist der Unterschied zu den Basisaufgaben (Ebene 1)?', answer: 'Die Basisaufgaben (Ebene 1) sind kurze, automatisch auswertbare Übungen direkt in einem Lernpaket. Hier in Ebene 2 entstehen die offenen Transfer-Aufgaben der ganzen Einheit – sie sind nicht an ein einzelnes Lernpaket gebunden, sondern werden später in den Lerntypen-Pfaden (Dashboards) eingesetzt.' },
        { question: 'Was ist die „Mission" einer Aufgabe?', answer: 'Beim Anlegen wählst du im Dialog die Art der Mission (z. B. Problem, Entdeckung, Recherche, Anwendung, Transfer, Kreativität). Sie beschreibt die didaktische Stoßrichtung – also welche Art von Denkleistung die Aufgabe von den Schüler:innen verlangt.' },
        { question: 'Was ist die KI-Ideenbox?', answer: 'Ein Assistent, der dir auf Basis deiner Einheit konkrete Aufgaben-Ideen vorschlägt. Du kannst einen Vorschlag übernehmen und ihn dann wie eine normale Aufgabe weiter ausarbeiten – ideal als Startpunkt, wenn du noch keine fertige Idee hast.' },
        { question: 'Was ist die Lernziel-Zuordnung?', answer: 'Du weist der Aufgabe per Drag & Drop genau die Lernziele zu, die sie trainiert. Brian.study nutzt diese Verknüpfung, um Schüler:innen bei Lücken gezielt auf passende Ebene-1-Übungen zurückzuverweisen.' },
        { question: 'Was ist der KI-Aufgaben-Assistent?', answer: 'Über den „Mit KI entwerfen"-Button (Zauberstab) kannst du eine grobe Idee eingeben – auch per Spracheingabe. Die KI erstellt daraus Titel, Aufgabenstellung und passende Lernziel-Vorschläge, die du danach noch anpassen kannst.' },
