 ...
 *
 * Schüler-Vorschau für die Abschluss-Aktivität „Bearbeitung bestätigen" –
 * rendert seit dem "Deckungsgleiche Vorschau"-Umbau (2026-06-12) die ECHTE
 * Schüler-Komponente (components/schueler/lesen/BearbeitungBestaetigenSeite)
 * im iPad-Rahmen. Damit ist die Lehrer-Vorschau 1:1 identisch mit der
 * Schüleransicht (inkl. Verständnis-Schieberegler).
 */
      ...
      <DialogContent className="max-h-[95vh] w-[95vw] max-w-[820px] overflow-y-auto bg-slate-100 p-4">
        <DialogHeader className="border-b border-slate-200 pb-3">
          ...
          <p className="text-xs text-slate-500 mt-1">
            Diese Vorschau zeigt exakt die Schüleransicht – du kannst die Bestätigung wie ein:e Schüler:in durchspielen. Die Buttons „Zurück" und „Bestätigen" sind in der Vorschau ohne Funktion.
          </p>
        </DialogHeader>
