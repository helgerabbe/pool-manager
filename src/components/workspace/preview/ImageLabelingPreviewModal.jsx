 ...
 *
 * Schüler-Vorschau für "Bildbeschriftung" – rendert seit dem "Deckungsgleiche
 * Vorschau"-Umbau (2026-06-12) die ECHTE Schüler-Komponente
 * (components/schueler/lesen/BildBeschriftungSeite) im iPad-Rahmen.
 *
...
export default function ImageLabelingPreviewModal({ open, onOpenChange, fieldValues = {}, catalogName = 'Bildbeschriftung', phase = 'Übung', masterHinweis }) {
  return (
