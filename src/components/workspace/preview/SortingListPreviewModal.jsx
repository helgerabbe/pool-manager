 ...
 *
 * Schüler-Vorschau für "Reihenfolge / Sortierung" im iPad-Frame (960×600-Slot).
 * Masterfähig: zeigt EINE Master-Variante.
 */
...
export default function SortingListPreviewModal({ open, onOpenChange, fieldValues = {}, catalogName = 'Reihenfolge / Sortierung', phase = 'Übung' }) {
  return (
          ...
          <IPadFrame lernpaketTitel={catalogName} phaseLabel={phase}>
            <div className="bg-white h-full flex flex-col">
              ...
              <div className="flex-1 min-h-0">
                <SortingListBody fieldValues={fieldValues} />
              </div>
            </div>
          </IPadFrame>
        </div>
