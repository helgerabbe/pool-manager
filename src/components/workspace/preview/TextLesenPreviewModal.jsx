 ...
 *
 * Schüler-Vorschau für "Text lesen" – rendert seit dem "Deckungsgleiche
 * Vorschau"-Umbau (2026-06-12) die ECHTE Schüler-Komponente
 * (components/schueler/lesen/TextLesenSeite) im iPad-Rahmen. Damit ist die
          ...
          <IPadFrame lernpaketTitel={catalogName || 'Text lesen'} phaseLabel={phase}>
            <div className="bg-background h-full overflow-hidden">
              <TextLesenSeite
                ...
                kat={{ name: catalogName || 'Text lesen' }}
                busy={false}
                onErledigt={() => {}}
                onBack={() => {}}
              />
