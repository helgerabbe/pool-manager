...
| 0.3 | 2026-05-12 | **Etappe 1 umgesetzt:** Datenmodell `Lernpakete.kreativ_briefing` (string, max. 5000 Zeichen) + `Lernpakete.kreativ_briefing_updated_at` (date-time) als optionale Felder ergänzt. Beide Felder sind nullable und ändern bestehende Lernpakete nicht. |
